        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div class="transition-all duration-300 hover:transform hover:scale-105">
                ...
                <div class="space-y-3">
                    <a href="https://wa.me/40751458644" target="_blank" rel="noopener noreferrer"
                        ...
                        <span class="transition-colors group-hover:text-indigo-400">+40 751 458 644</span>
                    </a>
            ...
            <div class="transition-all duration-300 hover:transform hover:scale-105">
                ...
                <div class="flex space-x-6">
                    <a href="https://www.facebook.com/Mihai.Stanciuc.5" class="text-gray-300 transition-transform hover:scale-110 hover:text-indigo-400">
                    ...
                    <a href="https://www.instagram.com/sax0mike" class="text-gray-300 transition-transform hover:scale-110 hover:text-indigo-400">
                    ...
                    <a href="https://www.youtube.com/@sax0mike" class="text-gray-300 transition-transform hover:scale-110 hover:text-indigo-400">
